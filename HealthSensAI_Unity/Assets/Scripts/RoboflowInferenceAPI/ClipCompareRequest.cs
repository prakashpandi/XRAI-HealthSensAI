...
/// </summary>
public class ClipCompareRequest
{
    /// <summary>
    /// Gets or sets the id.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ClipCompareRequest"/>.
    /// </summary>
    /// <param name="id">The id.</param>
    /// <param name="subject">The subject.</param>
    /// <param name="prompt">The prompt.</param>
    public ClipCompareRequest(string id, string subject, List<string> prompt)
    {
        this.Id = id;
