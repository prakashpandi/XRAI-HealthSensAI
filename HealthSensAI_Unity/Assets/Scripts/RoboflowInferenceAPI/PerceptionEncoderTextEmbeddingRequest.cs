...
/// </summary>
public class PerceptionEncoderTextEmbeddingRequest
{
    /// <summary>
    /// Gets or sets the id.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PerceptionEncoderTextEmbeddingRequest"/>.
    /// </summary>
    /// <param name="id">The id.</param>
    /// <param name="text">The text.</param>
    public PerceptionEncoderTextEmbeddingRequest(string id, List<string> text)
    {
        this.Id = id;
        this.Text = text;
    }
