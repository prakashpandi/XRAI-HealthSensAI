...
/// </summary>
public class TrOCRInferenceRequest
{
    /// <summary>
    /// Gets or sets the id.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the trocr_version_id.
    /// </summary>
    [JsonProperty("trocr_version_id")] 
    public string Trocr_Version_Id { get; set; }
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="TrOCRInferenceRequest"/>.
    /// </summary>
    /// <param name="id">The id.</param>
    /// <param name="image">The image.</param>
    public TrOCRInferenceRequest(string id, List<InferenceRequestImage> image)
    {
        this.Id = id;
        this.Image = image;
    }
