...
public class ObjectDetectionPrediction
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ObjectDetectionPrediction"/>.
    /// </summary>
    ...
    public ObjectDetectionPrediction(float x, float y, float width, float height, float confidence, string @class, int class_Id)
    {
        this.X = x;
        this.Y = y;
        this.Width = width;
