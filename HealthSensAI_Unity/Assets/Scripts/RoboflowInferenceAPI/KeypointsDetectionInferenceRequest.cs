...
/// <summary>
/// Represents the KeypointsDetectionInferenceRequest schema.
/// </summary>
public class KeypointsDetectionInferenceRequest
{
    /// <summary>
    /// Gets or sets the id.
    /// </summary>
    ...
    /// <summary>
    /// The confidence threshold used to filter out non visible keypoints
    /// </summary>
    [JsonProperty("keypoint_confidence")] 
    public float? Keypoint_Confidence { get; set; }

    /// <summary>
    /// Initializes a new instance of <see cref="KeypointsDetectionInferenceRequest"/>.
    /// </summary>
    /// <param name="id">The id.</param>
    /// <param name="model_Id">The model_Id.</param>
    /// <param name="image">The image.</param>
    //public KeypointsDetectionInferenceRequest(string id, string model_Id, List<InferenceRequestImage> image)
    public KeypointsDetectionInferenceRequest(string model_Id, InferenceRequestImage image, string id="0")
    {
        this.Id = id;
