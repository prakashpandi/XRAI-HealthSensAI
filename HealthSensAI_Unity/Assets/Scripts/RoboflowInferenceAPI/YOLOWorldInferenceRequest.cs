...
/// </summary>
public class YOLOWorldInferenceRequest
{
    /// <summary>
    /// Gets or sets the id.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the yolo_world_version_id.
    /// </summary>
    [JsonProperty("yolo_world_version_id")] 
    public string Yolo_World_Version_Id { get; set; }
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="YOLOWorldInferenceRequest"/>.
    /// </summary>
    /// <param name="id">The id.</param>
    /// <param name="image">The image.</param>
    /// <param name="text">The text.</param>
    public YOLOWorldInferenceRequest(string id, List<InferenceRequestImage> image, List<string> text)
    {
        this.Id = id;
        this.Image = image;
        this.Text = text;
