...
/// </summary>
public class PerceptionEncoderCompareResponse
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PerceptionEncoderCompareResponse"/>.
    /// </summary>
    /// <param name="similarity">The similarity.</param>
    public PerceptionEncoderCompareResponse(List<float> similarity)
    {
